...
const SignUp: React.FC = () => {
  function nextStep(): void {
    ...
    if (step1 && step2 && step1Status && step2Status) {
      step1.classList.add("hidden");
      step1Status.classList.remove("border-blue-600");
      step1Status.classList.remove("dark:border-blue-600");
      step1Status.classList.add("border-gray-300");
      step1Status.classList.add("dark:border-gray-300");
      step2.classList.remove("hidden");
      step2Status.classList.remove("border-gray-300");
      step2Status.classList.remove("dark:border-gray-300");
      step2Status.classList.add("border-blue-600");
      step2Status.classList.add("dark:border-blue-600");
    }
  }
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">{DESCRIPTION}</p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <ol className="mb-4 w-full items-center space-y-4 sm:flex sm:space-x-8 sm:space-y-0 rtl:space-x-reverse">
                <li className="flex items-center space-x-2.5 text-blue-600 dark:text-blue-500 rtl:space-x-reverse">
                  <span className="step-1-status flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-blue-600 dark:border-blue-500">
                    1
                  </span>
                  <span>
                ...
                <li className="step-2-status text-gray-500 dark:text-gray-400 flex items-center space-x-2.5 rtl:space-x-reverse">
                  <span className="border-gray-500 dark:border-gray-400 flex h-8 w-8 shrink-0 items-center justify-center rounded-full border">
                    2
                  </span>
                  <span>
                    <h3 className="font-medium leading-tight">Informations complémentaires</h3>
