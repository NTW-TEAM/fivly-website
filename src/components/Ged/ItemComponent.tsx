...
interface ItemComponentProps {
    ...
    currentPath: string;
    user: UserJwt;
    refreshFolderContents?: () => void;  // Add this line
}
...
const ItemComponent: React.FC<ItemComponentProps> = ({
                                                         ...
                                                         currentPath,
                                                         user,
                                                         refreshFolderContents = () => {}, // Provide a default no-op function
                                                     }) => {
    ...
    const handleRenameItem = async () => {
        ...
        if (newName) {
            try {
                ...
                refreshFolderContents(); // Refresh folder contents
            } catch (error) {
                ToastHandler.toast(
        ...
        return (
            <>
                ...
                <AddItemModal
                    ...
                    refreshFolderContents={refreshFolderContents} // Pass it here as well
                />
            </>
        );
    }
